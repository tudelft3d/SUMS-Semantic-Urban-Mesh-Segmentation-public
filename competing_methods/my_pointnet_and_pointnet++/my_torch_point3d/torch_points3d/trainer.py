...
class Trainer:
        ...
        with Ctq(train_loader) as tq_train_loader:
            ...
            for i, data in enumerate(tq_train_loader):
                ...
                if self._visualizer.is_active:
                    # not test yet
                    self._visualizer.get_file_names(train_loader.dataset.raw_dir, train_loader.dataset.name, vis_data_i)
                ...
                with Ctq(loader) as tq_loader:
                    ...
                    for data in tq_loader:
                        ...
                        if self.has_visualization and self._visualizer.is_active:
                            self._visualizer.get_file_names(loader.dataset.raw_dir, stage_name, vis_data_i)
                            self._visualizer.save_visuals(self._model.get_current_visuals())
                            vis_data_i += 1
    ...
    def has_visualization(self):
        return getattr(self._cfg, "visualization", True) # False
