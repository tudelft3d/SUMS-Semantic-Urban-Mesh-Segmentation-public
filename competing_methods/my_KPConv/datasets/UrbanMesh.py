    ...
    def load_subsampled_clouds(self):
        ...
        for i, file_path in enumerate(self.files):
            ...
            if exists(KDTree_file):
                ...
                data, sub_colors, sub_labels = read_ply_with_plyfilelib(sub_ply_file)
                ...
                # Read ply file
                xyz, rgb, rawlabels = read_ply_with_plyfilelib(file_path)
                points = xyz
                ...
                write_ply_with_plyfilelib(sub_ply_file, sub_points, sub_colors, sub_labels)
