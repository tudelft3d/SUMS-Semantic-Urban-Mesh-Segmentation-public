...
def main():
    ...
    parser.add_argument('--model_config', default='gru_10,f_6',
    ...
    def train():
        ...
        loader = torch.utils.data.DataLoader(train_dataset, batch_size=args.batch_size, collate_fn=spg.eccpc_collate,
