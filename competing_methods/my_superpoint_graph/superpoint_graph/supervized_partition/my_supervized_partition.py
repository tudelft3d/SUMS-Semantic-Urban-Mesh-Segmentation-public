...
def parse_args():
    ...
    ###################Change param##########################change for train(20) or testing(-1)
    ...
    parser.add_argument('--CP_cutoff', default=50, type=int, help='Minimum accepted component size in cut pursuit. if negative, chose with respect tot his number and the reg_strength as explained in the paper')
