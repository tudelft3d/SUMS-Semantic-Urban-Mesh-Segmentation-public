...
parser.add_argument('--ROOT_PATH', default='../datasets/custom_set4', help='folder containing the ./data folder')
parser.add_argument('--res_file', default='../datasets/custom_set4/results/predictions_test',
