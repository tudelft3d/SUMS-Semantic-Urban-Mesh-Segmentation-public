...
from tester_UrbanMesh import ModelTester
from helper_ply import read_ply
from helper_tool import Plot
from helper_tool import DataProcessing as DP
from helper_tool import ConfigUrbanMesh as cfg
...
class UrbanMesh:
    def __init__(self):
        ...
        for folder in folders:
            ...
            for file in files:
                ...
                if folder == "train/":
                    self.train_files.append(join(self.sub_pc_folder, file_name + '.ply'))
                elif folder == "test/":
                    self.test_files.append(join(self.full_pc_folder, file_name + '.ply'))
                elif folder == "validate/":
                    self.val_files.append(join(self.sub_pc_folder, file_name + '.ply'))
    ...
    def load_sub_sampled_clouds(self, sub_grid_size):
        ...
        for i, file_path in enumerate(files):
            ...
            print(str(i) + " / " + str(n_files) + "---> " + cloud_name)
        ...
        def spatially_regular_gen():
            ...
            for i in range(num_per_epoch):  # num_per_epoch
                ...
                if split == 'test':
                    ...
                    queried_pt_weight = np.array([self.class_weight[split][0][n] for n in queried_pc_labels]) # 1
