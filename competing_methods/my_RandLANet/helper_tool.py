import open3d #from open3d import linux as open3d
...
class ConfigUrbanMesh:
    k_n = 16 # 16  # KNN
    num_layers = 5  # Number of layers
    num_points = 200000  # Number of input points, depends on the GPU memory
    num_classes = 6  # Number of valid classes
    sub_grid_size = 0.01  # preprocess_parameter

    batch_size = 1 #4  # batch_size during training
    val_batch_size = 1 # 16  # batch_size during validation and test
    train_steps = 500 # 500  # Number of steps per epochs
    val_steps = 100 # 100  # Number of validation steps per epoch
...
class DataProcessing:
    ...
    def get_class_weights(dataset_name):
        ...
        elif dataset_name is 'UrbanMesh':
            num_per_class = np.array([47134956,33425255,105259026,15148602,2378792,952302], dtype=np.int32) #np.array([1, 1, 1, 1, 1, 1], dtype=np.int32)#
