...
namespace easy3d {
    ...
    public:
         ...
         */
        static float
        average_space(PointCloud *cloud, KdTree *kdtree = nullptr, int k = 6, bool accurate = false,
                      int samples = 10000
        );
        ...
        uniform_simplification(PointCloud *cloud, float epsilon, KdTree *kdtree = nullptr);
