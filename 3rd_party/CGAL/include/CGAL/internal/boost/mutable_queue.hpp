...
//=======================================================================
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-5.0-beta1/STL_Extension/include/CGAL/internal/boost/mutable_queue.hpp $
// $Id: mutable_queue.hpp a472c24 %aI Andreas Fabri
