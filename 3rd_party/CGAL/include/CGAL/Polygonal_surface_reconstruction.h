...
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-5.0-beta1/Polygonal_surface_reconstruction/include/CGAL/Polygonal_surface_reconstruction.h $
// $Id: Polygonal_surface_reconstruction.h e450266 %aI Simon Giraudot
...
namespace CGAL {
	...
	*/
		...
		double wt_complexity /* = 0.30 */)
	{
		...
		std::cout << ";  total_variables = " << total_variables;
		//if (total_variables > 5000)
		//{
