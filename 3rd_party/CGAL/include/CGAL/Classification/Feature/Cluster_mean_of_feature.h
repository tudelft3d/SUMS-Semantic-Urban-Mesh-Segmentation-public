...
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/Classification/include/CGAL/Classification/Feature/Cluster_mean_of_feature.h $
// $Id: Cluster_mean_of_feature.h 29433bc %aI Simon Giraudot
...
public:
  ...
  */
  ...
  {
	  return typeid(Cluster_mean_of_feature);
  };
  ////*******************************************************************//
};
