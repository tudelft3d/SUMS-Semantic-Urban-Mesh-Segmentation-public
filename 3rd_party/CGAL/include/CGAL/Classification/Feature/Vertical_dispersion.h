...
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/Classification/include/CGAL/Classification/Feature/Vertical_dispersion.h $
...
public:
  ...
  */
  ...
  {
	  return typeid(Vertical_dispersion);
  };
  ////*******************************************************************//
};
