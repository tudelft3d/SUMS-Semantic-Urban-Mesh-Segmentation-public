...
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/Classification/include/CGAL/Classification/Feature/Gradient_of_feature.h $
// $Id: Gradient_of_feature.h 155e9c8 %aI Simon Giraudot
...
public:
  ...
  */
  ...
  {
	  return typeid(Gradient_of_feature);
  };
  ////*******************************************************************//
};
