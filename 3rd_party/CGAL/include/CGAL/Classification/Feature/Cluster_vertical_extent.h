...
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/Classification/include/CGAL/Classification/Feature/Cluster_vertical_extent.h $
// $Id: Cluster_vertical_extent.h 29433bc %aI Simon Giraudot
...
public:
  ...
  */
  ...
  {
	  return typeid(Cluster_vertical_extent);
  };
  ////*******************************************************************//
};
