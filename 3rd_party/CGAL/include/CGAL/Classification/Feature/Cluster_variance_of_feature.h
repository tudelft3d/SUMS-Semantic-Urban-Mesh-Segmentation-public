...
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-4.14/Classification/include/CGAL/Classification/Feature/Cluster_variance_of_feature.h $
...
public:
  ...
  */
  ...
  {
	  return typeid(Cluster_variance_of_feature);
  };
  ////*******************************************************************//
};
