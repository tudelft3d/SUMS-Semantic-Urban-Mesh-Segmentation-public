...
//
// $URL: https://github.com/CGAL/cgal/blob/releases/CGAL-5.0-beta1/Principal_component_analysis/include/CGAL/PCA_util.h $
// $Id: PCA_util.h f3baef9 %aI Simon Giraudot
		...
		const DiagonalizeTraits& )                 // Diagonalize traits
{
  ...
  else // regular and line case
  {
	...
	//--------------Weixiao Update------------------//
	return FT(1) - eigen_values[0] / eigen_values[2];
  } // end regular case
}
